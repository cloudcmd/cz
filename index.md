...
lang:
 - name: English
   ...
   translation: Angličtina
 
 - name: Ukrainian
   link: http://ua.cloudcmd.io
   translation: Ukrajinský
...
**Cloud Commander** ortodoxní web správce souborů s konzolí a editor. Pomůže vám spravovat server a pracovat se soubory, adresáře a programy v prohlížeči z libovolného počítače, mobilního telefonu nebo tabletu.
